...
/**
 * This class was generated by Apache CXF 3.1.2-jbossorg-2 2015-11-08T14:18:26.819+01:00 Generated
...
public interface PagseguroCheckOutWebServiceImpl {
  ...
  public DoCheckoutDetailsResponse doCheckoutDetails(
      @WebParam(partName = "parameters", name = "doCheckoutDetails", targetNamespace = "http://gnuob.netbrasoft.com/") DoCheckoutDetails parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public DoCheckoutPaymentResponse doCheckoutPayment(
      @WebParam(partName = "parameters", name = "doCheckoutPayment", targetNamespace = "http://gnuob.netbrasoft.com/") DoCheckoutPayment parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public DoNotificationResponse doNotification(
      @WebParam(partName = "parameters", name = "doNotification", targetNamespace = "http://gnuob.netbrasoft.com/") DoNotification parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public DoRefundTransactionResponse doRefundTransaction(
      @WebParam(partName = "parameters", name = "doRefundTransaction", targetNamespace = "http://gnuob.netbrasoft.com/") DoRefundTransaction parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public DoTransactionDetailsResponse doTransactionDetails(
      @WebParam(partName = "parameters", name = "doTransactionDetails", targetNamespace = "http://gnuob.netbrasoft.com/") DoTransactionDetails parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
}
