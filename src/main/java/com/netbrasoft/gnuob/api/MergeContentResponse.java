...
/**
 * <p>
 * Java class for mergeContentResponse complex type.
 *
 * <p>
...
@XmlType(name = "mergeContentResponse", propOrder = {"_return"})
public class MergeContentResponse implements Serializable {
   ...
   * 
   */
  public void setReturn(final Content value) {
    this._return = value;
  }
