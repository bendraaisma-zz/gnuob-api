...
/**
 * This class was generated by Apache CXF 3.0.4 2015-06-13T20:34:00.484+02:00
...
public class PagseguroCheckOutWebServiceImplService extends Service {
   ...
   static {
      ...
      try {
         ...
         java.util.logging.Logger.getLogger(PagseguroCheckOutWebServiceImplService.class.getName()).log(java.util.logging.Level.INFO, "Can not initialize the default wsdl from {0}", "http://localhost:8080/gnuob-soap/PagseguroCheckOutWebServiceImpl?wsdl");
      }
      WSDL_LOCATION = url;
   }
