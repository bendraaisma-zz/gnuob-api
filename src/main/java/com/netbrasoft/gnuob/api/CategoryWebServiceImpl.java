...
/**
 * This class was generated by Apache CXF 3.1.2-jbossorg-2 2015-11-08T14:18:28.837+01:00 Generated
...
public interface CategoryWebServiceImpl {
  ...
  public FindCategoryByIdResponse findCategoryById(
      @WebParam(partName = "parameters", name = "findCategoryById", targetNamespace = "http://gnuob.netbrasoft.com/") FindCategoryById parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public PersistCategoryResponse persistCategory(
      @WebParam(partName = "parameters", name = "persistCategory", targetNamespace = "http://gnuob.netbrasoft.com/") PersistCategory parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public RefreshCategoryResponse refreshCategory(
      @WebParam(partName = "parameters", name = "refreshCategory", targetNamespace = "http://gnuob.netbrasoft.com/") RefreshCategory parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public RemoveCategoryResponse removeCategory(
      @WebParam(partName = "parameters", name = "removeCategory", targetNamespace = "http://gnuob.netbrasoft.com/") RemoveCategory parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
}
