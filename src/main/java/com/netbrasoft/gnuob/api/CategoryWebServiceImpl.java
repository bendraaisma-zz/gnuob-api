...
/**
 * This class was generated by Apache CXF 3.1.2-jbossorg-2 2015-10-23T20:19:13.033+02:00 Generated
...
public interface CategoryWebServiceImpl {
  ...
  public MergeCategoryResponse mergeCategory(
      @WebParam(partName = "parameters", name = "mergeCategory", targetNamespace = "http://gnuob.netbrasoft.com/") MergeCategory parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public CountCategoryResponse countCategory(
      @WebParam(partName = "parameters", name = "countCategory", targetNamespace = "http://gnuob.netbrasoft.com/") CountCategory parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
