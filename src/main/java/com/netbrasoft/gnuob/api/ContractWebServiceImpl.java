...
/**
 * This class was generated by Apache CXF 3.1.2-jbossorg-2 2015-11-08T14:18:30.885+01:00 Generated
...
public interface ContractWebServiceImpl {
  ...
  public FindContractByIdResponse findContractById(
      @WebParam(partName = "parameters", name = "findContractById", targetNamespace = "http://gnuob.netbrasoft.com/") FindContractById parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public PersistContractResponse persistContract(
      @WebParam(partName = "parameters", name = "persistContract", targetNamespace = "http://gnuob.netbrasoft.com/") PersistContract parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public RefreshContractResponse refreshContract(
      @WebParam(partName = "parameters", name = "refreshContract", targetNamespace = "http://gnuob.netbrasoft.com/") RefreshContract parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public RemoveContractResponse removeContract(
      @WebParam(partName = "parameters", name = "removeContract", targetNamespace = "http://gnuob.netbrasoft.com/") RemoveContract parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
}
