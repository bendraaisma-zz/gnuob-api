...
/**
 * This class was generated by Apache CXF 3.1.2-jbossorg-2 2015-10-23T20:19:15.845+02:00 Generated
...
public interface ContractWebServiceImpl {
  ...
  public MergeContractResponse mergeContract(
      @WebParam(partName = "parameters", name = "mergeContract", targetNamespace = "http://gnuob.netbrasoft.com/") MergeContract parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public CountContractResponse countContract(
      @WebParam(partName = "parameters", name = "countContract", targetNamespace = "http://gnuob.netbrasoft.com/") CountContract parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
