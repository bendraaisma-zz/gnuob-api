...
/**
 * This class was generated by Apache CXF 3.1.2-jbossorg-2 2015-10-23T20:19:05.568+02:00 Generated
...
public interface ProductWebServiceImpl {
  ...
  public RefreshProductResponse refreshProduct(
      @WebParam(partName = "parameters", name = "refreshProduct", targetNamespace = "http://gnuob.netbrasoft.com/") RefreshProduct parameters,
  ...
  public PersistProductResponse persistProduct(
      @WebParam(partName = "parameters", name = "persistProduct", targetNamespace = "http://gnuob.netbrasoft.com/") PersistProduct parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public FindProductByIdResponse findProductById(
      @WebParam(partName = "parameters", name = "findProductById", targetNamespace = "http://gnuob.netbrasoft.com/") FindProductById parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public RemoveProductResponse removeProduct(
      @WebParam(partName = "parameters", name = "removeProduct", targetNamespace = "http://gnuob.netbrasoft.com/") RemoveProduct parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
