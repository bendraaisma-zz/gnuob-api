...
/**
 * This class was generated by Apache CXF 3.1.2-jbossorg-2 2015-10-23T20:19:18.421+02:00 Generated
...
public interface CustomerWebServiceImpl {
  ...
  public RefreshCustomerResponse refreshCustomer(
      @WebParam(partName = "parameters", name = "refreshCustomer", targetNamespace = "http://gnuob.netbrasoft.com/") RefreshCustomer parameters,
  ...
  public MergeCustomerResponse mergeCustomer(
      @WebParam(partName = "parameters", name = "mergeCustomer", targetNamespace = "http://gnuob.netbrasoft.com/") MergeCustomer parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public RemoveCustomerResponse removeCustomer(
      @WebParam(partName = "parameters", name = "removeCustomer", targetNamespace = "http://gnuob.netbrasoft.com/") RemoveCustomer parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public FindCustomerByIdResponse findCustomerById(
      @WebParam(partName = "parameters", name = "findCustomerById", targetNamespace = "http://gnuob.netbrasoft.com/") FindCustomerById parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public CountCustomerResponse countCustomer(
      @WebParam(partName = "parameters", name = "countCustomer", targetNamespace = "http://gnuob.netbrasoft.com/") CountCustomer parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public PersistCustomerResponse persistCustomer(
      @WebParam(partName = "parameters", name = "persistCustomer", targetNamespace = "http://gnuob.netbrasoft.com/") PersistCustomer parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
}
