 ...
 * 2015-08-15T14:37:13.961+02:00
 * Generated source version: 3.0.5
 * 
 */
@WebServiceClient(name = "SettingWebServiceImplService", 
                  wsdlLocation = "http://localhost:8080/gnuob-soap/SettingWebServiceImpl?wsdl",
...
public class SettingWebServiceImplService extends Service {
    ...
    static {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SettingWebServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/gnuob-soap/SettingWebServiceImpl?wsdl");
        }
        WSDL_LOCATION = url;
    }
