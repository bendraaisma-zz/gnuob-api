...
/**
 * This class was generated by Apache CXF 3.1.2-jbossorg-2 2015-11-08T14:18:42.779+01:00 Generated
...
public class SettingWebServiceImplService extends Service {
  ...
  public SettingWebServiceImplService(final URL wsdlLocation) {
    super(wsdlLocation, SERVICE);
  }

  public SettingWebServiceImplService(final URL wsdlLocation, final QName serviceName) {
    super(wsdlLocation, serviceName);
  }

  public SettingWebServiceImplService(final URL wsdlLocation, final QName serviceName, final WebServiceFeature... features) {
    super(wsdlLocation, serviceName, features);
  }

  public SettingWebServiceImplService(final URL wsdlLocation, final WebServiceFeature... features) {
    super(wsdlLocation, SERVICE, features);
  }

  public SettingWebServiceImplService(final WebServiceFeature... features) {
   ...
   */
  @WebEndpoint(name = "SettingWebServiceImplPort")
  public SettingWebServiceImpl getSettingWebServiceImplPort(final WebServiceFeature... features) {
