...
@XmlType(name = "order", propOrder = { "billingAgreementId", "checkout", "checkoutStatus", "contract", "custom", "discountTotal", "extraAmount", "giftMessage", "giftMessageEnable", "giftReceiptEnable", "giftWrapAmount", "giftWrapEnable", "giftWrapName",
      "handlingTotal", "insuranceOptionOffered", "insuranceTotal", "invoice", "itemTotal", "maxTotal", "note", "noteText", "notificationId", "orderDate", "orderDescription", "orderId", "orderTotal", "records", "shipment", "shippingDiscount",
      "shippingTotal", "taxTotal", "token", "transactionId" })
