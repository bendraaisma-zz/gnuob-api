...
public class Stock extends AbstractType implements Serializable {
   ...
   * 
   */
  public void setMaxQuantity(final BigInteger value) {
   ...
   * 
   */
  public void setMinQuantity(final BigInteger value) {
