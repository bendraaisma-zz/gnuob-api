...
@Monitored
@Controller(SITE_DATA_PROVIDER_NAME)
public class SiteDataProvider<S extends Site> extends AbstractGenericTypeDataProvider<S> {
  ...
  @Resource(name = SITE_WEB_SERVICE_REPOSITORY_NAME)
  private transient IGenericTypeWebServiceRepository<S> siteWebServiceRepository;
