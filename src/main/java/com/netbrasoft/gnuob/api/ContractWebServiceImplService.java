...
/**
 * This class was generated by Apache CXF 3.1.2-jbossorg-2 2015-11-08T14:18:30.919+01:00 Generated
 * source version: 3.1.2-jbossorg-2
 *
 */
@WebServiceClient(name = "ContractWebServiceImplService", wsdlLocation = "http://localhost:8080/gnuob-soap/ContractWebServiceImpl?wsdl",
...
public class ContractWebServiceImplService extends Service {
  ...
  static {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(ContractWebServiceImplService.class.getName()).log(java.util.logging.Level.INFO, "Can not initialize the default wsdl from {0}",
  ...
  public ContractWebServiceImplService(final URL wsdlLocation) {
    super(wsdlLocation, SERVICE);
  }

  public ContractWebServiceImplService(final URL wsdlLocation, final QName serviceName) {
    super(wsdlLocation, serviceName);
  }

  public ContractWebServiceImplService(final URL wsdlLocation, final QName serviceName, final WebServiceFeature... features) {
    super(wsdlLocation, serviceName, features);
  }

  public ContractWebServiceImplService(final URL wsdlLocation, final WebServiceFeature... features) {
    super(wsdlLocation, SERVICE, features);
  }

  public ContractWebServiceImplService(final WebServiceFeature... features) {
   ...
   */
  @WebEndpoint(name = "ContractWebServiceImplPort")
  public ContractWebServiceImpl getContractWebServiceImplPort(final WebServiceFeature... features) {
