...
/**
 * This class was generated by Apache CXF 3.1.2-jbossorg-2 2015-11-08T14:18:44.705+01:00 Generated
...
public class ContentWebServiceImplService extends Service {
  ...
  public ContentWebServiceImplService(final URL wsdlLocation) {
    super(wsdlLocation, SERVICE);
  }

  public ContentWebServiceImplService(final URL wsdlLocation, final QName serviceName) {
    super(wsdlLocation, serviceName);
  }

  public ContentWebServiceImplService(final URL wsdlLocation, final QName serviceName, final WebServiceFeature... features) {
    super(wsdlLocation, serviceName, features);
  }

  public ContentWebServiceImplService(final URL wsdlLocation, final WebServiceFeature... features) {
    super(wsdlLocation, SERVICE, features);
  }

  public ContentWebServiceImplService(final WebServiceFeature... features) {
   ...
   */
  @WebEndpoint(name = "ContentWebServiceImplPort")
  public ContentWebServiceImpl getContentWebServiceImplPort(final WebServiceFeature... features) {
