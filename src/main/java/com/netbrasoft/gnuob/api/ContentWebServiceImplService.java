 ...
 * 2015-08-23T15:23:16.862+02:00
 * Generated source version: 3.0.5
 * 
 */
@WebServiceClient(name = "ContentWebServiceImplService", 
                  wsdlLocation = "http://localhost:8080/gnuob-soap/ContentWebServiceImpl?wsdl",
...
public class ContentWebServiceImplService extends Service {
    ...
    static {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContentWebServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/gnuob-soap/ContentWebServiceImpl?wsdl");
        }
        WSDL_LOCATION = url;
    }
