...
/**
 * This class was generated by Apache CXF 3.1.2-jbossorg-2 2015-11-08T14:18:42.746+01:00 Generated
...
public interface SettingWebServiceImpl {
  ...
  public FindSettingByIdResponse findSettingById(
      @WebParam(partName = "parameters", name = "findSettingById", targetNamespace = "http://gnuob.netbrasoft.com/") FindSettingById parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public PersistSettingResponse persistSetting(
      @WebParam(partName = "parameters", name = "persistSetting", targetNamespace = "http://gnuob.netbrasoft.com/") PersistSetting parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
  ...
  public RefreshSettingResponse refreshSetting(
      @WebParam(partName = "parameters", name = "refreshSetting", targetNamespace = "http://gnuob.netbrasoft.com/") RefreshSetting parameters,
      @WebParam(partName = "metaData", name = "metaData", targetNamespace = "http://gnuob.netbrasoft.com/", header = true) MetaData metaData);
