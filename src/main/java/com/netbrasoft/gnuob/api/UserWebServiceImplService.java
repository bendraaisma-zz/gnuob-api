...
/**
 * This class was generated by Apache CXF 2.7.11 2014-08-31T16:53:18.298+02:00
...
public class UserWebServiceImplService extends Service {
	...
	static {
		URL url = null;
		try {
			url = new URL(System.getProperty("gnuob.user.site", "http://localhost:8080/gnuob-soap/UserWebServiceImpl?wsdl"));
		} catch (MalformedURLException e) {
			java.util.logging.Logger.getLogger(UserWebServiceImplService.class.getName()).log(java.util.logging.Level.INFO, "Can not initialize the default wsdl from {0}", "http://localhost:8080/gnuob-soap/UserWebServiceImpl?wsdl");
		}
		WSDL_LOCATION = url;
	}
