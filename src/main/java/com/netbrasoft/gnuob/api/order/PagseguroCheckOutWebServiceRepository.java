...
public class PagseguroCheckOutWebServiceRepository<O extends Order> implements CheckoutWebServiceRepository<O> {
   ...
   public O doCheckout(MetaData paramMetaData, O paramOrder) {
      ...
      DoCheckoutResponse doCheckoutResponse = getPagseguroCheckOutWebServiceImpl().doCheckout(paramDoCheckout,
            paramMetaData);
   ...
   public O doCheckoutDetails(MetaData paramMetaData, O paramOrder) {
      ...
      DoCheckoutDetailsResponse doCheckoutDetailsResponse = getPagseguroCheckOutWebServiceImpl().doCheckoutDetails(
   ...
   public O doCheckoutPayment(MetaData paramMetaData, O paramOrder) {
      ...
      DoCheckoutPaymentResponse doCheckoutPaymentResponse = getPagseguroCheckOutWebServiceImpl().doCheckoutPayment(
   ...
   private PagseguroCheckOutWebServiceImpl getPagseguroCheckOutWebServiceImpl() {
      if (pagseguroCheckOutWebServiceImpl == null) {
         PagseguroCheckOutWebServiceImplService pagseguroCheckOutWebServiceImplService = new PagseguroCheckOutWebServiceImplService(
               PagseguroCheckOutWebServiceImplService.WSDL_LOCATION);
         pagseguroCheckOutWebServiceImpl = pagseguroCheckOutWebServiceImplService
               .getPagseguroCheckOutWebServiceImplPort();
      }
