...
/**
 * The class {@code GNUOpenBusinessServiceException} and its subclasses are a
 * form of {@code Throwable} that indicates conditions that a reasonable
 * application might want to catch.
 *
 * <p>
 * The class {@code GNUOpenBusinessServiceException} and any subclasses that are
 * not also subclasses of {@link RuntimeException} are <em>checked
