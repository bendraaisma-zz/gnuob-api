...
public class XMLGregorianCalendarConverter implements IConverter<XMLGregorianCalendar> {
   ...
   @Override
   public XMLGregorianCalendar convertToObject(String value, Locale locale) throws ConversionException {
      try {
         final GregorianCalendar gregorianCalendar = new GregorianCalendar();
         gregorianCalendar.setTime(SimpleDateFormat.getDateInstance(DateFormat.SHORT, locale).parse(value));
