...
/**
 * This class was generated by Apache CXF 2.7.11 2014-12-04T22:22:30.524+01:00
...
public class SiteWebServiceImplService extends Service {
	...
	static {
		URL url = null;
		try {
			url = new URL(System.getProperty("gnuob.site.site", "http://localhost:8080/gnuob-soap/SiteWebServiceImpl?wsdl"));
		} catch (MalformedURLException e) {
			java.util.logging.Logger.getLogger(SiteWebServiceImplService.class.getName()).log(java.util.logging.Level.INFO, "Can not initialize the default wsdl from {0}", "http://localhost:8080/gnuob-soap/SiteWebServiceImpl?wsdl");
		}
		WSDL_LOCATION = url;
	}
