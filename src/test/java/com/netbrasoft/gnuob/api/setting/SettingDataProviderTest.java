...
public class SettingDataProviderTest {
  ...
  public void testFindSettingByIdAndNoEntityFound() {
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testFindSettingByIdWithNoAccess() {
    expectedException.expect(GNUOpenBusinessApplicationException.class);
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testFindSettingByIdWithReadAccess() {
    Setting settingById = new Setting();
    settingById.setActive(true);
    settingById.setId(400L);
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testFindSettingByIdWithRootAccess() {
    Setting settingById = new Setting();
    settingById.setActive(true);
    settingById.setId(400L);
    Setting detachedSetting = settingDataProvider.findById(settingById);
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testIteratorSettingCouldNotExtractResultSet() {
    expectedException.expect(GNUOpenBusinessApplicationException.class);
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testMergeSettingWithGroupOwnerShipAccess() {
    setting.setId(0L);
    setting.setVersion(0);
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testMergeSettingWithNoAccess() {
    expectedException.expect(GNUOpenBusinessApplicationException.class);
    expectedException.expectMessage(
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testMergeSettingWithOthersOwnerShipAccess() {
    setting.setId(0L);
    setting.setVersion(0);
    setting.setPermission(null);
    Setting detachedSetting = settingDataProvider.persist(setting);
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testMergeSettingWithRootAccess() {
    setting.setId(0L);
    setting.setVersion(0);
    setting.setPermission(null);
    Setting detachedSetting = settingDataProvider.persist(setting);
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testMergeSettingWithNoMergeAccess() {
    expectedException.expect(GNUOpenBusinessApplicationException.class);
    expectedException.expectMessage(
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testMergeSettingWithOwnerAccess() {
    setting.setId(0L);
    setting.setVersion(0);
    setting.setPermission(null);
    settingDataProvider.setUser("employee");
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testPersistSettingWithNoAccess() {
    expectedException.expect(GNUOpenBusinessApplicationException.class);
    expectedException.expectMessage(
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testPersistSettingWithNoPermissionSetAndWithRootAccess() {
    setting.setId(0L);
    setting.setVersion(0);
    setting.setPermission(null);
    Setting detachedSetting = settingDataProvider.persist(setting);
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testPersistSettingWithPermissionSetAndWithNoRootAccess() {
    setting.setId(0L);
    setting.setVersion(0);
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testRemoveSettingAndNoEntityFound() {
    expectedException.expect(GNUOpenBusinessApplicationException.class);
  ...
  @ApplyScriptBefore({"scripts/scriptsToExecuteBeforeTest.sql"})
  @UsingDataSet("datasets/settings.xml")
  public void testRemoveWithGroupAccess() {
    expectedException.expect(GNUOpenBusinessApplicationException.class);
    expectedException.expectMessage("No entity found by the given id and type (ERR01)");
    setting.setId(0L);
    setting.setVersion(0);
